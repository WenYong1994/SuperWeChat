...
public class SettingsActivity extends BaseActivity implements OnClickListener {
	...
	private ImageView mTvTitileBack;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTvTitileBack= (ImageView) findViewById(R.id.m_SettingActivity_Title_Back);
		...
		mTvTitileBack.setOnClickListener(this);
...
//				break;
			...
			case R.id.rl_custom_server:
				...
				break;
			case R.id.m_SettingActivity_Title_Back:
				MFGT.finish(this);
				break;
			default:
				break;
